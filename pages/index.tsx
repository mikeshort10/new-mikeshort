  ...
  return (
    <Layout title="Mike Short">
      <div className="home-pic h-screen bg-cover bg-center bg-no-repeat relative">
        <h1 className="text-6xl pt-24 absolute z-10 text-blue-800 tracking-widest font-mono md:pr-20 lg:pr-24 right-0">
          Mike Short
        </h1>
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <P>
            {" "}
            Outdoorsman, lover of literature, and always down for a craft beer
